...
public ResponseEntity<ApiResponse>delete(@Valid @PathVariable int id)
{
    ...
    return new ResponseEntity<ApiResponse>(new ApiResponse("id deleted successsfully",true),HttpStatus.OK);
}
@GetMapping("/getall")
public ResponseEntity<List<employee_payload>>getallusers(){
